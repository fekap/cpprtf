...
CppRtf_Endnote *CppRtf_Container::addEndnote(string noteText, CppRtf_Font *font, CppRtf_ParFormat *parFormat)
{
...
CppRtf_FormField_Text *CppRtf_Container::addTextField(CppRtf_Font *font, CppRtf_ParFormat *parFormat)
{
