...
public:
    ...
    //adds an endnote
    CppRtf_Endnote* addEndnote(string noteText, CppRtf_Font* font = 0, CppRtf_ParFormat* parFormat = 0);
    ...
    //adds text field
    CppRtf_FormField_Text* addTextField(CppRtf_Font* font = 0, CppRtf_ParFormat* parFormat = 0);
};
