...
int main()
{
    ...
    CppRtf_Font* font = new CppRtf_Font(14, "Arial", "#000066");
    CppRtf_Font* defaultFontForNotes = new CppRtf_Font(10);
    ...
    CppRtf_Font* fontNotes = new CppRtf_Font(24, "Arial", "#333333");
